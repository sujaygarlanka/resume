...
%-----------Summary-----------
\small A Software Engineer who has experience in robotics research through the development of action primitives using algorithmic and distributed reinforcement learning approaches in simulation. Also, has 3 years of experience working with enterprise scale data processing, developing APIs and building heavily used open source libraries for developers to interact with those APIs. Has full stack development experience as well. \textit{A U.S. citizen and authorized to work for any U.S. employer.}
  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Paper including my work: \href{https://arxiv.org/pdf/2403.09227}{\underline{https://arxiv.org/pdf/2403.09227}}}
     \resumeItemListEnd 
     \vspace{5pt}
    ...
    \href{https://sujaygarlanka.com/experience/svl/}{\underline{More Details} \ldots}
...
%-------------------------------------------
    ...
    \href{https://sujaygarlanka.com/experience/box-internship/}{\underline{More Details} \ldots}
\resumeSubHeadingListEnd
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Frameworks/Tools}{: ROS2, IsaacSim, Slurm, Stable Baselines 3, Weights and Biases, gRPC, Apache Spark, oclif CLI Framework, Mocha Testing Framework, Travis CI, Jenkins} \\
    }}
 \end{itemize}
