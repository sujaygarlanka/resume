...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Research Engineer}{Palo Alto/Los Angeles, CA}
      \resumeItemListStart
        \resumeItem{Developing functionality for the open-source robotics simulator, \href{https://behavior.stanford.edu/omnigibson/}{\underline{OmniGibson}}, built on Nvidia's IsaacSim simulation platform}
        ...
        \resumeItem{Developing action primitives using reinforcement learning. I helped create a distributed learning setup using GRPC. The setup includes a vector client environment running on a node for the RL learner that connects over the network to an N number of OmniGibson environments on other nodes.}
        \resumeItem{Currently using the distributed setup to deploy RL experiments on a Slurm cluster with Stables Baselines 3 to train a policy and Weights and Biases to track policy and computational performance}
     \resumeItemListEnd
     \emph{Technologies:} Python, GRPC, Slurm, Stable Baselines 3, Weights and Biases 
     
    \href{https://github.com/StanfordVL/OmniGibson/pull/282}{\underline{Github Pull Request} \ldots}
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Frameworks/Tools}{: GRPC, Apache Spark, Oclif CLI Framework, Travis CI, Jenkins} \\
    }}
 \end{itemize}
